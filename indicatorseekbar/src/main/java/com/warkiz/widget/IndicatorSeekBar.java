...
public class IndicatorSeekBar extends View implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mShader == null) {
            mShader = new LinearGradient(0, 0, mMeasuredWidth, 60, new int[]{Color.parseColor("#FF9E06"), Color.parseColor("#FF6E3F"), Color.parseColor("#DE3030")}, null, Shader.TileMode.CLAMP);

        }
        mStockPaint.setShader(mShader);
